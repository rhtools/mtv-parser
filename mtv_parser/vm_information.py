...
def create_timeline(
    ...
    current_vms: Dict[str, List[str]],
    max_concurrent: Dict[str, int],
) -> Tuple[List[Dict[str, Any]], int, Optional[datetime], float, float]:
    """
    ...
    Returns:
        Tuple[List[Dict[str, Any]], int, Optional[datetime], float, float]: A tuple containing the timeline, max concurrent total,
                                                                            peak time, total VM minutes, and total duration minutes.
    """
    peak_time = None
...
def get_avg_concurrent_count(hourly_counts: dict) -> float:
...
def analyze_concurrent_migrations(
    ...
    (
        ...
        max_concurrent_total,
        peak_time,
    ) = create_timeline(events, concurrent_counts, current_vms, max_concurrent)
    ...
    avg_concurrent_vms = get_avg_concurrent_count(hourly_counts)
